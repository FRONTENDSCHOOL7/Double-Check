...
✔️ **더블책(Double Chaek)** 은 독서 커뮤니티 플랫폼으로, 책에 대한 정보 제공과 사용자 간의 리뷰 공유를 넘어서 **더블 체크** 라는 개념에 중점을 두고 있습니다. 이 플랫폼은 사용자들이 책을 읽고, 그들의 이해와 감상을 리뷰하거나 인상적인 문구를 공유함으로써, 한 번 더 생각하는 기회를 제공합니다.

✔️ 네이버와 알라딘의 **도서 API** 를 활용하여 추천 도서를 제공하며, 이를 통해 사용자들이 자신의 해석을 **더블 체크**하고, 다른 독자들과 의견을 교환하며 독서 경험을 풍부하게 할 수 있도록 돕습니다.

✔️ 프로젝트명 **더블책** 은 이러한 **더블 체크** 의 과정을 통해 독서가 갖는 의미와 가치를 재확인하는 데서 영감을 받았습니다.
