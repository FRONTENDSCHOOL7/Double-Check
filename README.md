...
- #### 주요 기능 및 사용자 경험 강화
  사용자들 간의 소통을 촉진하기 위해 커뮤니티 특성을 강조합니다. 프로젝트에서는 읽은 도서에 대한 피드 작성 기능을 강화하여 사용자들 간의 활발한 교류를 유도할 것입니다. 이러한 방향성을 바탕으로 읽을 책, 읽은 책, 저장할 책 등의 탭을 도입하여 사용자들이 자신의 독서 활동을 체계적으로 기록하고 관리할 수 있도록 합니다. 
